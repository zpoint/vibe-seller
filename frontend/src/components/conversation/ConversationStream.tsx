...
const PROSE_RESULT = 'prose prose-neutral max-w-none text-[16px] leading-[1.6] prose-code:text-[13px] prose-code:font-mono prose-code:text-gray-800 prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:before:content-none prose-code:after:content-none prose-pre:bg-gray-50 prose-pre:text-gray-800 prose-pre:border prose-pre:border-gray-200 prose-pre:rounded prose-pre:p-3 prose-pre:my-3 prose-pre:text-[13px] prose-h1:text-[18px] prose-h1:font-bold prose-h1:text-gray-900 prose-h1:border-b prose-h1:border-gray-200 prose-h1:pb-2 prose-h1:mb-3 prose-h2:text-[15px] prose-h2:font-semibold prose-h2:text-gray-800 prose-h2:border-b prose-h2:border-gray-100 prose-h2:pb-1.5 prose-h2:mb-2.5 prose-h2:mt-5 prose-p:my-2.5 prose-p:text-gray-800 prose-p:leading-[1.6] prose-ul:my-2.5 prose-ul:pl-5 prose-li:my-1 prose-li:marker:text-gray-400'
